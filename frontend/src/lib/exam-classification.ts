...
const PROVIDER_ROUTES: readonly ProviderRoute[] = [
  ...
  { idPrefix: "teacher-recruit-newtaipei", examClass: "教師資格考試", defaultSubclass: "新北市教師甄試" },
  { idPrefix: "teacher-recruit-taoyuan-elementary", examClass: "教師資格考試", defaultSubclass: "桃園市國小教師甄試" },
  { idPrefix: "teacher-recruit-kaohsiung", examClass: "教師資格考試", defaultSubclass: "高雄市教師甄試" },
  { idPrefix: "teacher-recruit-central-alliance", examClass: "教師資格考試", defaultSubclass: "中區策略聯盟教師甄試" },
  ...
  { idPrefix: "gept-cert", examClass: "語言檢定", defaultSubclass: "全民英檢 GEPT" },
