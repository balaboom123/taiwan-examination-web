...
| `python -m app discover --provider moex --manifest data/providers/moex/source-manifest.json --write-manifest --delay-seconds 1` | you want to persist an official year/exam discovery snapshot | stdout JSON and provider source manifest |
