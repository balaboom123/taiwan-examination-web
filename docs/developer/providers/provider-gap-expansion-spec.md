...
|---|---|---|
| 技術士技能檢定 | Implemented | Fixed `wdasec_skill` WebForms postback replay, refreshed official AD 2009–2024 sessions alongside existing 2025–2026 state, and published eligible `wdasec-skill` groups; 38 older events remain normalization gaps. |
