...
1. `wdasec_skill`: fixed WebForms postback hidden-field replay, refreshed the official 2007–2024 sessions alongside existing 2025–2026 state, and published eligible `wdasec-skill` groups; 110 events are complete, five are explicitly excluded by site policy, and 28 older events through AD 2006 remain normalization gaps.
